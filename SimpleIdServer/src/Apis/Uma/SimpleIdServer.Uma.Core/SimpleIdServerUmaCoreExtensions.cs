...
namespace SimpleIdServer.Uma.Core
{
    public static class SimpleIdServerUmaCoreExtensions
    {
        ...
        public static IServiceCollection AddSimpleIdServerUmaWebsite(this IServiceCollection serviceCollection, ICollection<ResourceSet> resources = null, ICollection<SharedLink> sharedLinks = null, ICollection<Policy> policies = null)
        {
            ...
            serviceCollection.AddTransient<IPendingRequestsActions, PendingRequestsActions>();
            serviceCollection.AddTransient<IGetPendingRequestsAction, GetPendingRequestsAction>();
            serviceCollection.AddTransient<IRejectPendingRequestAction, RejectPendingRequestAction>();
            serviceCollection.AddTransient<IAcceptPendingRequestAction, AcceptPendingRequestAction>();
