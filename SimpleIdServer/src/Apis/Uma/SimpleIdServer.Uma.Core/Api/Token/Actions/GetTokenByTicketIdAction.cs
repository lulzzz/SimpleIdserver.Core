...
namespace SimpleIdServer.Uma.Core.Api.Token.Actions
{
    ...
    internal sealed class GetTokenByTicketIdAction : IGetTokenByTicketIdAction
    {
        ...
        public async Task<GrantedToken> GenerateTokenAsync(SimpleIdServer.Core.Common.Models.Client client, IEnumerable<TicketLine> ticketLines, string scope, string issuerName)
        {
            if (client == null)
            {
