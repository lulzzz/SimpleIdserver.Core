...
using SimpleIdServer.Scim.Core.EF;
...
namespace SimpleIdServer.Scim.Db.EF.Stores
{
    internal class RepresentationStore : IRepresentationStore
    {
        ...
        public async Task<PaginatedResult<Representation>> SearchRepresentations(string resourceType, SearchParameter searchParameter)
        {
            ...
            IQueryable<Core.EF.Models.Representation> representations = _context.Representations
        ...
        private List<RepresentationAttribute> GetRepresentationAttributes(List<Core.EF.Models.RepresentationAttribute> attributes)
        {
            if (attributes == null)
            {
        ...
        private List<Core.EF.Models.RepresentationAttribute> GetRepresentationAttributes(Representation representation)
        {
            if (representation.Attributes == null)
            {
                return new List<Core.EF.Models.RepresentationAttribute>();
            }

            var result = new List<Core.EF.Models.RepresentationAttribute>();
        ...
        private void RemoveAttributes(List<Core.EF.Models.RepresentationAttribute> attributes)
        {
            foreach(var attribute in attributes)
            {
