...
using Representation = SimpleIdServer.Scim.Common.Models.Representation;

namespace SimpleIdServer.Scim.Core.EF.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static SchemaResponse ToDomain(this Schema schema)
        {
            if (schema == null)
            {
        ...
        public static Meta ToDomain(this MetaData meta)
        {
            if (meta == null)
            {
