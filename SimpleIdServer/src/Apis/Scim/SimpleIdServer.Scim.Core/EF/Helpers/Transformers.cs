...
namespace SimpleIdServer.Scim.Core.EF.Helpers
{
    public interface ITransformers
    {
        SchemaAttributeResponse Transform(SchemaAttribute attr);
    ...
    public class Transformers : ITransformers
    {
        ...
        public RepresentationAttribute Transform(Models.RepresentationAttribute attr)
        {
