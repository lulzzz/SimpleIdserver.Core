...
namespace SimpleIdServer.Core.Validators
{
    ...
    internal class ScopeValidator : IScopeValidator
    {
        ...
        private ParameterParserHelper parameterParserHelper;
        ...
        public ScopeValidator(ParameterParserHelper parameterParserHelper)
        {
            this.parameterParserHelper = parameterParserHelper;
        }
