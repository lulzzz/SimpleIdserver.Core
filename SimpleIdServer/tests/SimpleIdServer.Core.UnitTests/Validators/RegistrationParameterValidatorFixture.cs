...
namespace SimpleIdentityServer.Core.UnitTests.Validators
{
    public sealed class RegistrationParameterValidatorFixture
    {
        ...
        public void When_There_Is_No_Request_Uri_Then_Exception_Is_Thrown()
        {
            ...
            Assert.True(ex.Message == string.Format(ErrorDescriptions.MissingParameter, SimpleIdServer.Dtos.Constants.ClientNames.RequestUris));
        }
        ...
        public void When_GrantType_Is_Not_Defined_Then_Set_To_Authorization_Code()
        {
            ...
            Assert.True(parameter.GrantTypes.Contains(GrantType.authorization_code));
        }
        ...
        public void When_Logo_Uri_Is_Not_Valid_Then_Exception_Is_Thrown()
        {
            ...
            Assert.True(ex.Message == string.Format(ErrorDescriptions.ParameterIsNotCorrect, SimpleIdServer.Dtos.Constants.ClientNames.LogoUri));
        }
        ...
        public void When_Client_Uri_Is_Not_Valid_Then_Exception_Is_Thrown()
        {
            ...
            var ex = Assert.Throws<IdentityServerException>(() => _registrationParameterValidator.Validate(parameter));
            Assert.True(ex.Code == ErrorCodes.InvalidClientMetaData);
            Assert.True(ex.Message == string.Format(ErrorDescriptions.ParameterIsNotCorrect, SimpleIdServer.Dtos.Constants.ClientNames.ClientUri));
        }
        ...
        public void When_Tos_Uri_Is_Not_Valid_Then_Exception_Is_Thrown()
        {
            ...
            var ex = Assert.Throws<IdentityServerException>(() => _registrationParameterValidator.Validate(parameter));
            Assert.True(ex.Code == ErrorCodes.InvalidClientMetaData);
            Assert.True(ex.Message == string.Format(ErrorDescriptions.ParameterIsNotCorrect, SimpleIdServer.Dtos.Constants.ClientNames.TosUri));
        }
        ...
        public void When_Jwks_Uri_Is_Not_Valid_Then_Exception_Is_Thrown()
        {
            ...
            var ex = Assert.Throws<IdentityServerException>(() => _registrationParameterValidator.Validate(parameter));
            Assert.True(ex.Code == ErrorCodes.InvalidClientMetaData);
            Assert.True(ex.Message == string.Format(ErrorDescriptions.ParameterIsNotCorrect, SimpleIdServer.Dtos.Constants.ClientNames.JwksUri));
        }
        ...
        public void When_SectorIdentifierUri_Is_Not_A_Redirect_Uri_Then_Exception_Is_Thrown()
        {
            ...
            var json = JsonConvert.SerializeObject(sectorIdentifierUris);
        ...
        public void When_Passing_Valid_Request_Then_No_Exception_Is_Thrown()
        {
            ...
            var parameter = new RegistrationParameter
            {
                ...
                Jwks = new JsonWebKeySet(),
                IdTokenEncryptedResponseAlg = Constants.JweAlgNames.A128KW,
                IdTokenEncryptedResponseEnc = Constants.JweEncNames.A128CBC_HS256,
                UserInfoEncryptedResponseAlg = Constants.JweAlgNames.A128KW,
                UserInfoEncryptedResponseEnc = Constants.JweEncNames.A128CBC_HS256,
                RequestObjectEncryptionAlg = Constants.JweAlgNames.A128KW,
                RequestObjectEncryptionEnc = Constants.JweEncNames.A128CBC_HS256,
                RequestUris = new List<string>
                {
                    "http://localhost"
