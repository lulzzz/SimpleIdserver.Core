...
{
    public class RejectPendingRequestActionFixture
    {
        private Mock<IPendingRequestRepository> _pendingRequestRepositoryStub;
        private IRejectPendingRequestAction _rejectPendingRequestAction;
        ...
        public async Task When_PendingRequest_Doesnt_Exist_Then_Exception_Is_Thrown()
        {
            ...
            // ACT
            await Assert.ThrowsAsync<UmaPolicyNotFoundException>(() => _rejectPendingRequestAction.Execute("subject","id"));
        }

        [Fact]
        public async Task When_User_Is_Not_Authorized_To_Reject_Pending_Request_Then_Exception_Is_Thrown()
        {
            // ARRANGE
            InitializeFakeObjects();
        ...
        private void InitializeFakeObjects()
        {
            ...
            _rejectPendingRequestAction = new RejectPendingRequestAction(_pendingRequestRepositoryStub.Object);
        }
    }
}
